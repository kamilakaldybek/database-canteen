...
-- —амые попул€рные блюда кафе 'Villa Dei Fiori' в апреле и сколько раз его заказали
...
-- —редн€€ выручка в день каждого кафе и их количество клиентов 
...
--  лиент который сделал больше 3 заказа
...
-- Ќаибольша€ выручка официанта из всех ресторанов, наибольша€ выручка официанта из кафе 'Shavlego' и разница выручек 
...
--4.  оличество первого блюда, второго, закусок, десертов
-- исскуственна€ таблица где наход€тс€ только блюда категории 'First Course'
CREATE VIEW first_course_dish As
SELECT Type,Name FROM Dish
WHERE Type='First Course';

-- исскуственна€ таблица где наход€тс€ только блюда категории 'Second Course'
CREATE VIEW second_course_dish As
SELECT Type,Name FROM Dish
WHERE Type='Second Course';

-- исскуственна€ таблица где наход€тс€ только блюда категории 'Dessert'
CREATE VIEW dessert_dish As
SELECT Type,Name FROM Dish
WHERE Type='Dessert';

-- исскуственна€ таблица где наход€тс€ только блюда категории 'Appetizer'
...
-- DELETE QUERY
--”даление Ѕлюда в названии которых есть слово 'Salad'
